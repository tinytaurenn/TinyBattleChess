...
namespace Coherence.Generated
{
    ...
    public struct _d9c58831288052b4bb0dfa57ee24e75e_4055558226076958478 : ICoherenceComponentData
    {
        ...
        {
            FieldsMask |= _d9c58831288052b4bb0dfa57ee24e75e_4055558226076958478.m_IsHeldMask;
            m_IsHeldSimulationFrame = frame;
            FieldsMask |= _d9c58831288052b4bb0dfa57ee24e75e_4055558226076958478.IsNPCHeldMask;
            IsNPCHeldSimulationFrame = frame;
        }

        public static unsafe _d9c58831288052b4bb0dfa57ee24e75e_4055558226076958478 FromInterop(IntPtr data, Int32 dataSize, InteropAbsoluteSimulationFrame* simFrames, Int32 simFramesCount)
        {
            if (dataSize != 2) {
            ...
            var orig = new _d9c58831288052b4bb0dfa57ee24e75e_4055558226076958478();
        ...
        {
            var other = (_d9c58831288052b4bb0dfa57ee24e75e_4055558226076958478)data;
        ...
        public static uint Serialize(_d9c58831288052b4bb0dfa57ee24e75e_4055558226076958478 data, bool isRefSimFrameValid, AbsoluteSimulationFrame referenceSimulationFrame, IOutProtocolBitStream bitStream, Logger logger)
        {
        ...
        public static _d9c58831288052b4bb0dfa57ee24e75e_4055558226076958478 Deserialize(AbsoluteSimulationFrame referenceSimulationFrame, InProtocolBitStream bitStream)
        {
            ...
            var val = new _d9c58831288052b4bb0dfa57ee24e75e_4055558226076958478();
            if (bitStream.ReadMask())
            {

                val.m_IsHeld = bitStream.ReadBool();
                val.FieldsMask |= _d9c58831288052b4bb0dfa57ee24e75e_4055558226076958478.m_IsHeldMask;
            }
            if (bitStream.ReadMask())
            {

                val.IsNPCHeld = bitStream.ReadBool();
                val.FieldsMask |= _d9c58831288052b4bb0dfa57ee24e75e_4055558226076958478.IsNPCHeldMask;
            }
        ...
        {
            return $"_d9c58831288052b4bb0dfa57ee24e75e_4055558226076958478(" +
