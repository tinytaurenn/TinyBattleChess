...
namespace Coherence.Generated
{
    ...
    public struct _52c50e470fcf1e3419d4bf3ed75d999e_17161935702122925116 : ICoherenceComponentData
    {
        ...
        {
            FieldsMask |= _52c50e470fcf1e3419d4bf3ed75d999e_17161935702122925116.m_IsHeldMask;
            m_IsHeldSimulationFrame = frame;
            FieldsMask |= _52c50e470fcf1e3419d4bf3ed75d999e_17161935702122925116.IsNPCHeldMask;
            IsNPCHeldSimulationFrame = frame;
        }

        public static unsafe _52c50e470fcf1e3419d4bf3ed75d999e_17161935702122925116 FromInterop(IntPtr data, Int32 dataSize, InteropAbsoluteSimulationFrame* simFrames, Int32 simFramesCount)
        {
            if (dataSize != 2) {
            ...
            var orig = new _52c50e470fcf1e3419d4bf3ed75d999e_17161935702122925116();
        ...
        {
            var other = (_52c50e470fcf1e3419d4bf3ed75d999e_17161935702122925116)data;
        ...
        public static uint Serialize(_52c50e470fcf1e3419d4bf3ed75d999e_17161935702122925116 data, bool isRefSimFrameValid, AbsoluteSimulationFrame referenceSimulationFrame, IOutProtocolBitStream bitStream, Logger logger)
        {
        ...
        public static _52c50e470fcf1e3419d4bf3ed75d999e_17161935702122925116 Deserialize(AbsoluteSimulationFrame referenceSimulationFrame, InProtocolBitStream bitStream)
        {
            ...
            var val = new _52c50e470fcf1e3419d4bf3ed75d999e_17161935702122925116();
            if (bitStream.ReadMask())
            {

                val.m_IsHeld = bitStream.ReadBool();
                val.FieldsMask |= _52c50e470fcf1e3419d4bf3ed75d999e_17161935702122925116.m_IsHeldMask;
            }
            if (bitStream.ReadMask())
            {

                val.IsNPCHeld = bitStream.ReadBool();
                val.FieldsMask |= _52c50e470fcf1e3419d4bf3ed75d999e_17161935702122925116.IsNPCHeldMask;
            }
        ...
        {
            return $"_52c50e470fcf1e3419d4bf3ed75d999e_17161935702122925116(" +
