...
namespace Coherence.Generated
{
    ...
    public struct _61db515efe9556c45853cdc384e6813b_59e034c4b9784967ba52fc25c9c44fa2 : IEntityCommand
    {
        ...
        public static unsafe _61db515efe9556c45853cdc384e6813b_59e034c4b9784967ba52fc25c9c44fa2 FromInterop(System.IntPtr data, System.Int32 dataSize) 
        {
            if (dataSize != 4) {
            ...
            var orig = new _61db515efe9556c45853cdc384e6813b_59e034c4b9784967ba52fc25c9c44fa2();
        ...
        public _61db515efe9556c45853cdc384e6813b_59e034c4b9784967ba52fc25c9c44fa2(
        Entity entity,
        ...
        public static void Serialize(_61db515efe9556c45853cdc384e6813b_59e034c4b9784967ba52fc25c9c44fa2 commandData, IOutProtocolBitStream bitStream)
        {
            bitStream.WriteIntegerRange(commandData.choiceIndex, 32, -2147483648);
        }
        
        public static _61db515efe9556c45853cdc384e6813b_59e034c4b9784967ba52fc25c9c44fa2 Deserialize(IInProtocolBitStream bitStream, Entity entity, MessageTarget target)
        {
            var datachoiceIndex = bitStream.ReadIntegerRange(32, -2147483648);
    
            return new _61db515efe9556c45853cdc384e6813b_59e034c4b9784967ba52fc25c9c44fa2()
            {
                Entity = entity,
                Routing = target,
