...
namespace Coherence.Generated
{
    ...
    public struct _5ca4159d3bce41449a6ca5773f57e7ef_1046041548547050077 : ICoherenceComponentData
    {
        ...
        {
            FieldsMask |= _5ca4159d3bce41449a6ca5773f57e7ef_1046041548547050077.pathMask;
            pathSimulationFrame = frame;
            FieldsMask |= _5ca4159d3bce41449a6ca5773f57e7ef_1046041548547050077.pathDirtyCounterMask;
            pathDirtyCounterSimulationFrame = frame;
        }

        public static unsafe _5ca4159d3bce41449a6ca5773f57e7ef_1046041548547050077 FromInterop(IntPtr data, Int32 dataSize, InteropAbsoluteSimulationFrame* simFrames, Int32 simFramesCount)
        {
            if (dataSize != 20) {
            ...
            var orig = new _5ca4159d3bce41449a6ca5773f57e7ef_1046041548547050077();
        ...
        {
            var other = (_5ca4159d3bce41449a6ca5773f57e7ef_1046041548547050077)data;
        ...
        public static uint Serialize(_5ca4159d3bce41449a6ca5773f57e7ef_1046041548547050077 data, bool isRefSimFrameValid, AbsoluteSimulationFrame referenceSimulationFrame, IOutProtocolBitStream bitStream, Logger logger)
        {
            ...
            if (bitStream.WriteMask((mask & 0x01) != 0))
            {
                ...
                Coherence.Utils.Bounds.Check(data.pathDirtyCounter, _pathDirtyCounter_Min, _pathDirtyCounter_Max, "_5ca4159d3bce41449a6ca5773f57e7ef_1046041548547050077.pathDirtyCounter", logger);
        ...
        public static _5ca4159d3bce41449a6ca5773f57e7ef_1046041548547050077 Deserialize(AbsoluteSimulationFrame referenceSimulationFrame, InProtocolBitStream bitStream)
        {
            ...
            var val = new _5ca4159d3bce41449a6ca5773f57e7ef_1046041548547050077();
            if (bitStream.ReadMask())
            {

                val.path = bitStream.ReadShortString();
                val.FieldsMask |= _5ca4159d3bce41449a6ca5773f57e7ef_1046041548547050077.pathMask;
            }
            if (bitStream.ReadMask())
            {

                val.pathDirtyCounter = bitStream.ReadIntegerRange(32, -2147483648);
                val.FieldsMask |= _5ca4159d3bce41449a6ca5773f57e7ef_1046041548547050077.pathDirtyCounterMask;
            }
        ...
        {
            return $"_5ca4159d3bce41449a6ca5773f57e7ef_1046041548547050077(" +
                $" path: { this.path }" +
