...
namespace Coherence.Generated
{
    ...
    public struct _d74ec397b646aca44b0b3a0dd609d93f_3290036067546008819 : ICoherenceComponentData
    {
        ...
        {
            FieldsMask |= _d74ec397b646aca44b0b3a0dd609d93f_3290036067546008819.m_IsHeldMask;
            m_IsHeldSimulationFrame = frame;
            FieldsMask |= _d74ec397b646aca44b0b3a0dd609d93f_3290036067546008819.IsNPCHeldMask;
            IsNPCHeldSimulationFrame = frame;
        }

        public static unsafe _d74ec397b646aca44b0b3a0dd609d93f_3290036067546008819 FromInterop(IntPtr data, Int32 dataSize, InteropAbsoluteSimulationFrame* simFrames, Int32 simFramesCount)
        {
            if (dataSize != 2) {
            ...
            var orig = new _d74ec397b646aca44b0b3a0dd609d93f_3290036067546008819();
        ...
        {
            var other = (_d74ec397b646aca44b0b3a0dd609d93f_3290036067546008819)data;
        ...
        public static uint Serialize(_d74ec397b646aca44b0b3a0dd609d93f_3290036067546008819 data, bool isRefSimFrameValid, AbsoluteSimulationFrame referenceSimulationFrame, IOutProtocolBitStream bitStream, Logger logger)
        {
        ...
        public static _d74ec397b646aca44b0b3a0dd609d93f_3290036067546008819 Deserialize(AbsoluteSimulationFrame referenceSimulationFrame, InProtocolBitStream bitStream)
        {
            ...
            var val = new _d74ec397b646aca44b0b3a0dd609d93f_3290036067546008819();
            if (bitStream.ReadMask())
            {

                val.m_IsHeld = bitStream.ReadBool();
                val.FieldsMask |= _d74ec397b646aca44b0b3a0dd609d93f_3290036067546008819.m_IsHeldMask;
            }
            if (bitStream.ReadMask())
            {

                val.IsNPCHeld = bitStream.ReadBool();
                val.FieldsMask |= _d74ec397b646aca44b0b3a0dd609d93f_3290036067546008819.IsNPCHeldMask;
            }
        ...
        {
            return $"_d74ec397b646aca44b0b3a0dd609d93f_3290036067546008819(" +
