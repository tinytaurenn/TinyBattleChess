...
namespace Coherence.Generated
{
    ...
    public struct _d74ec397b646aca44b0b3a0dd609d93f_11207334821781059830 : ICoherenceComponentData
    {
        ...
        {
            FieldsMask |= _d74ec397b646aca44b0b3a0dd609d93f_11207334821781059830.pathMask;
            pathSimulationFrame = frame;
            FieldsMask |= _d74ec397b646aca44b0b3a0dd609d93f_11207334821781059830.pathDirtyCounterMask;
            pathDirtyCounterSimulationFrame = frame;
        }

        public static unsafe _d74ec397b646aca44b0b3a0dd609d93f_11207334821781059830 FromInterop(IntPtr data, Int32 dataSize, InteropAbsoluteSimulationFrame* simFrames, Int32 simFramesCount)
        {
            if (dataSize != 20) {
            ...
            var orig = new _d74ec397b646aca44b0b3a0dd609d93f_11207334821781059830();
        ...
        {
            var other = (_d74ec397b646aca44b0b3a0dd609d93f_11207334821781059830)data;
        ...
        public static uint Serialize(_d74ec397b646aca44b0b3a0dd609d93f_11207334821781059830 data, bool isRefSimFrameValid, AbsoluteSimulationFrame referenceSimulationFrame, IOutProtocolBitStream bitStream, Logger logger)
        {
            ...
            if (bitStream.WriteMask((mask & 0x01) != 0))
            {
                ...
                Coherence.Utils.Bounds.Check(data.pathDirtyCounter, _pathDirtyCounter_Min, _pathDirtyCounter_Max, "_d74ec397b646aca44b0b3a0dd609d93f_11207334821781059830.pathDirtyCounter", logger);
        ...
        public static _d74ec397b646aca44b0b3a0dd609d93f_11207334821781059830 Deserialize(AbsoluteSimulationFrame referenceSimulationFrame, InProtocolBitStream bitStream)
        {
            ...
            var val = new _d74ec397b646aca44b0b3a0dd609d93f_11207334821781059830();
            if (bitStream.ReadMask())
            {

                val.path = bitStream.ReadShortString();
                val.FieldsMask |= _d74ec397b646aca44b0b3a0dd609d93f_11207334821781059830.pathMask;
            }
            if (bitStream.ReadMask())
            {

                val.pathDirtyCounter = bitStream.ReadIntegerRange(32, -2147483648);
                val.FieldsMask |= _d74ec397b646aca44b0b3a0dd609d93f_11207334821781059830.pathDirtyCounterMask;
            }
        ...
        {
            return $"_d74ec397b646aca44b0b3a0dd609d93f_11207334821781059830(" +
                $" path: { this.path }" +
