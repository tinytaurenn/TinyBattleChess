...
namespace Coherence.Generated
{
    ...
    public struct _0f6b5aa5bcd577f4aa6ed491962442e0_1923514185311723796 : ICoherenceComponentData
    {
        ...
        {
            FieldsMask |= _0f6b5aa5bcd577f4aa6ed491962442e0_1923514185311723796.pathMask;
            pathSimulationFrame = frame;
            FieldsMask |= _0f6b5aa5bcd577f4aa6ed491962442e0_1923514185311723796.pathDirtyCounterMask;
            pathDirtyCounterSimulationFrame = frame;
        }

        public static unsafe _0f6b5aa5bcd577f4aa6ed491962442e0_1923514185311723796 FromInterop(IntPtr data, Int32 dataSize, InteropAbsoluteSimulationFrame* simFrames, Int32 simFramesCount)
        {
            if (dataSize != 20) {
            ...
            var orig = new _0f6b5aa5bcd577f4aa6ed491962442e0_1923514185311723796();
        ...
        {
            var other = (_0f6b5aa5bcd577f4aa6ed491962442e0_1923514185311723796)data;
        ...
        public static uint Serialize(_0f6b5aa5bcd577f4aa6ed491962442e0_1923514185311723796 data, bool isRefSimFrameValid, AbsoluteSimulationFrame referenceSimulationFrame, IOutProtocolBitStream bitStream, Logger logger)
        {
            ...
            if (bitStream.WriteMask((mask & 0x01) != 0))
            {
                ...
                Coherence.Utils.Bounds.Check(data.pathDirtyCounter, _pathDirtyCounter_Min, _pathDirtyCounter_Max, "_0f6b5aa5bcd577f4aa6ed491962442e0_1923514185311723796.pathDirtyCounter", logger);
        ...
        public static _0f6b5aa5bcd577f4aa6ed491962442e0_1923514185311723796 Deserialize(AbsoluteSimulationFrame referenceSimulationFrame, InProtocolBitStream bitStream)
        {
            ...
            var val = new _0f6b5aa5bcd577f4aa6ed491962442e0_1923514185311723796();
            if (bitStream.ReadMask())
            {

                val.path = bitStream.ReadShortString();
                val.FieldsMask |= _0f6b5aa5bcd577f4aa6ed491962442e0_1923514185311723796.pathMask;
            }
            if (bitStream.ReadMask())
            {

                val.pathDirtyCounter = bitStream.ReadIntegerRange(32, -2147483648);
                val.FieldsMask |= _0f6b5aa5bcd577f4aa6ed491962442e0_1923514185311723796.pathDirtyCounterMask;
            }
        ...
        {
            return $"_0f6b5aa5bcd577f4aa6ed491962442e0_1923514185311723796(" +
                $" path: { this.path }" +
