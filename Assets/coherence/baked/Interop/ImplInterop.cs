    ...
    public class DataInteropHandler : IDataInteropHandler
    {
        ...
        public unsafe IEntityCommand GetCommand(UInt32 type, IntPtr data, Int32 dataSize)
        {
            switch (type)
            {
                  ...
                  case 11: return _5358ed04715b0f148a60e93c83f08be0_1bf0d010dc224b1faa2b8d174a9df334.FromInterop(data, dataSize);
        ...
        public unsafe bool SendCommand(INativeCoreCommandSender sender, InteropEntity entity, MessageTarget target, IEntityCommand command)
        {
            ...
            switch (type)
            {
                ...
                case 11:
                {
                    var orig = (_5358ed04715b0f148a60e93c83f08be0_1bf0d010dc224b1faa2b8d174a9df334)command;
                    var val = new _5358ed04715b0f148a60e93c83f08be0_1bf0d010dc224b1faa2b8d174a9df334.Interop();
