...
namespace Coherence.Generated
{
    ...
    public struct _5bdd7302d83b75e4ea45b36178bc0730_4509086355188942050 : ICoherenceComponentData
    {
        ...
        {
            FieldsMask |= _5bdd7302d83b75e4ea45b36178bc0730_4509086355188942050.rotationMask;
            rotationSimulationFrame = frame;
            FieldsMask |= _5bdd7302d83b75e4ea45b36178bc0730_4509086355188942050.positionMask;
            positionSimulationFrame = frame;
        }

        public static unsafe _5bdd7302d83b75e4ea45b36178bc0730_4509086355188942050 FromInterop(IntPtr data, Int32 dataSize, InteropAbsoluteSimulationFrame* simFrames, Int32 simFramesCount)
        {
            if (dataSize != 28) {
            ...
            var orig = new _5bdd7302d83b75e4ea45b36178bc0730_4509086355188942050();
        ...
        public AbsoluteSimulationFrame? GetMinSimulationFrame()
        {
            ...
            if ((FieldsMask & _5bdd7302d83b75e4ea45b36178bc0730_4509086355188942050.rotationMask) != 0 && (min == null || this.rotationSimulationFrame < min))
            {
                min = this.rotationSimulationFrame;
            }
            if ((FieldsMask & _5bdd7302d83b75e4ea45b36178bc0730_4509086355188942050.positionMask) != 0 && (min == null || this.positionSimulationFrame < min))
            {
        ...
        {
            var other = (_5bdd7302d83b75e4ea45b36178bc0730_4509086355188942050)data;
        ...
        public static uint Serialize(_5bdd7302d83b75e4ea45b36178bc0730_4509086355188942050 data, bool isRefSimFrameValid, AbsoluteSimulationFrame referenceSimulationFrame, IOutProtocolBitStream bitStream, Logger logger)
        {
        ...
        public static _5bdd7302d83b75e4ea45b36178bc0730_4509086355188942050 Deserialize(AbsoluteSimulationFrame referenceSimulationFrame, InProtocolBitStream bitStream)
        {
            ...
            var val = new _5bdd7302d83b75e4ea45b36178bc0730_4509086355188942050();
            if (bitStream.ReadMask())
            {
                ...
                val.FieldsMask |= _5bdd7302d83b75e4ea45b36178bc0730_4509086355188942050.rotationMask;
            }
            if (bitStream.ReadMask())
            {
                ...
                val.FieldsMask |= _5bdd7302d83b75e4ea45b36178bc0730_4509086355188942050.positionMask;
            }
        ...
        {
            return $"_5bdd7302d83b75e4ea45b36178bc0730_4509086355188942050(" +
