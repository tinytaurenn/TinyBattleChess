...
namespace Coherence.Generated
{
    ...
    public struct _52c50e470fcf1e3419d4bf3ed75d999e_17500377362836339264 : ICoherenceComponentData
    {
        ...
        {
            FieldsMask |= _52c50e470fcf1e3419d4bf3ed75d999e_17500377362836339264.pathMask;
            pathSimulationFrame = frame;
            FieldsMask |= _52c50e470fcf1e3419d4bf3ed75d999e_17500377362836339264.pathDirtyCounterMask;
            pathDirtyCounterSimulationFrame = frame;
        }

        public static unsafe _52c50e470fcf1e3419d4bf3ed75d999e_17500377362836339264 FromInterop(IntPtr data, Int32 dataSize, InteropAbsoluteSimulationFrame* simFrames, Int32 simFramesCount)
        {
            if (dataSize != 20) {
            ...
            var orig = new _52c50e470fcf1e3419d4bf3ed75d999e_17500377362836339264();
        ...
        {
            var other = (_52c50e470fcf1e3419d4bf3ed75d999e_17500377362836339264)data;
        ...
        public static uint Serialize(_52c50e470fcf1e3419d4bf3ed75d999e_17500377362836339264 data, bool isRefSimFrameValid, AbsoluteSimulationFrame referenceSimulationFrame, IOutProtocolBitStream bitStream, Logger logger)
        {
            ...
            if (bitStream.WriteMask((mask & 0x01) != 0))
            {
                ...
                Coherence.Utils.Bounds.Check(data.pathDirtyCounter, _pathDirtyCounter_Min, _pathDirtyCounter_Max, "_52c50e470fcf1e3419d4bf3ed75d999e_17500377362836339264.pathDirtyCounter", logger);
        ...
        public static _52c50e470fcf1e3419d4bf3ed75d999e_17500377362836339264 Deserialize(AbsoluteSimulationFrame referenceSimulationFrame, InProtocolBitStream bitStream)
        {
            ...
            var val = new _52c50e470fcf1e3419d4bf3ed75d999e_17500377362836339264();
            if (bitStream.ReadMask())
            {

                val.path = bitStream.ReadShortString();
                val.FieldsMask |= _52c50e470fcf1e3419d4bf3ed75d999e_17500377362836339264.pathMask;
            }
            if (bitStream.ReadMask())
            {

                val.pathDirtyCounter = bitStream.ReadIntegerRange(32, -2147483648);
                val.FieldsMask |= _52c50e470fcf1e3419d4bf3ed75d999e_17500377362836339264.pathDirtyCounterMask;
            }
        ...
        {
            return $"_52c50e470fcf1e3419d4bf3ed75d999e_17500377362836339264(" +
                $" path: { this.path }" +
