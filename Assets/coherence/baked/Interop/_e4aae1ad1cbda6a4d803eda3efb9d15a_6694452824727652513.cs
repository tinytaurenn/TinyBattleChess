...
namespace Coherence.Generated
{
    ...
    public struct _e4aae1ad1cbda6a4d803eda3efb9d15a_6694452824727652513 : ICoherenceComponentData
    {
        ...
        {
            FieldsMask |= _e4aae1ad1cbda6a4d803eda3efb9d15a_6694452824727652513.pathMask;
            pathSimulationFrame = frame;
            FieldsMask |= _e4aae1ad1cbda6a4d803eda3efb9d15a_6694452824727652513.pathDirtyCounterMask;
            pathDirtyCounterSimulationFrame = frame;
        }

        public static unsafe _e4aae1ad1cbda6a4d803eda3efb9d15a_6694452824727652513 FromInterop(IntPtr data, Int32 dataSize, InteropAbsoluteSimulationFrame* simFrames, Int32 simFramesCount)
        {
            if (dataSize != 20) {
                throw new Exception($"Given data size is not equal to the struct size. ({dataSize} != 20) " +
                    "for component with ID 238");
            }
            ...
            var orig = new _e4aae1ad1cbda6a4d803eda3efb9d15a_6694452824727652513();
        ...
        public uint GetComponentType() => 238;
        ...
        {
            var other = (_e4aae1ad1cbda6a4d803eda3efb9d15a_6694452824727652513)data;
        ...
        public static uint Serialize(_e4aae1ad1cbda6a4d803eda3efb9d15a_6694452824727652513 data, bool isRefSimFrameValid, AbsoluteSimulationFrame referenceSimulationFrame, IOutProtocolBitStream bitStream, Logger logger)
        {
            ...
            if (bitStream.WriteMask((mask & 0x01) != 0))
            {
                ...
                Coherence.Utils.Bounds.Check(data.pathDirtyCounter, _pathDirtyCounter_Min, _pathDirtyCounter_Max, "_e4aae1ad1cbda6a4d803eda3efb9d15a_6694452824727652513.pathDirtyCounter", logger);
        ...
        public static _e4aae1ad1cbda6a4d803eda3efb9d15a_6694452824727652513 Deserialize(AbsoluteSimulationFrame referenceSimulationFrame, InProtocolBitStream bitStream)
        {
            ...
            var val = new _e4aae1ad1cbda6a4d803eda3efb9d15a_6694452824727652513();
            if (bitStream.ReadMask())
            {

                val.path = bitStream.ReadShortString();
                val.FieldsMask |= _e4aae1ad1cbda6a4d803eda3efb9d15a_6694452824727652513.pathMask;
            }
            if (bitStream.ReadMask())
            {

                val.pathDirtyCounter = bitStream.ReadIntegerRange(32, -2147483648);
                val.FieldsMask |= _e4aae1ad1cbda6a4d803eda3efb9d15a_6694452824727652513.pathDirtyCounterMask;
            }
        ...
        {
            return $"_e4aae1ad1cbda6a4d803eda3efb9d15a_6694452824727652513(" +
                $" path: { this.path }" +
