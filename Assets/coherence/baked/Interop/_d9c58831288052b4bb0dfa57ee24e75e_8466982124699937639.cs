...
namespace Coherence.Generated
{
    ...
    public struct _d9c58831288052b4bb0dfa57ee24e75e_8466982124699937639 : ICoherenceComponentData
    {
        ...
        {
            FieldsMask |= _d9c58831288052b4bb0dfa57ee24e75e_8466982124699937639.pathMask;
            pathSimulationFrame = frame;
            FieldsMask |= _d9c58831288052b4bb0dfa57ee24e75e_8466982124699937639.pathDirtyCounterMask;
            pathDirtyCounterSimulationFrame = frame;
        }

        public static unsafe _d9c58831288052b4bb0dfa57ee24e75e_8466982124699937639 FromInterop(IntPtr data, Int32 dataSize, InteropAbsoluteSimulationFrame* simFrames, Int32 simFramesCount)
        {
            if (dataSize != 20) {
                throw new Exception($"Given data size is not equal to the struct size. ({dataSize} != 20) " +
                    "for component with ID 237");
            }
            ...
            var orig = new _d9c58831288052b4bb0dfa57ee24e75e_8466982124699937639();
        ...
        public uint GetComponentType() => 237;
        ...
        {
            var other = (_d9c58831288052b4bb0dfa57ee24e75e_8466982124699937639)data;
        ...
        public static uint Serialize(_d9c58831288052b4bb0dfa57ee24e75e_8466982124699937639 data, bool isRefSimFrameValid, AbsoluteSimulationFrame referenceSimulationFrame, IOutProtocolBitStream bitStream, Logger logger)
        {
            ...
            if (bitStream.WriteMask((mask & 0x01) != 0))
            {
                ...
                Coherence.Utils.Bounds.Check(data.pathDirtyCounter, _pathDirtyCounter_Min, _pathDirtyCounter_Max, "_d9c58831288052b4bb0dfa57ee24e75e_8466982124699937639.pathDirtyCounter", logger);
        ...
        public static _d9c58831288052b4bb0dfa57ee24e75e_8466982124699937639 Deserialize(AbsoluteSimulationFrame referenceSimulationFrame, InProtocolBitStream bitStream)
        {
            ...
            var val = new _d9c58831288052b4bb0dfa57ee24e75e_8466982124699937639();
            if (bitStream.ReadMask())
            {

                val.path = bitStream.ReadShortString();
                val.FieldsMask |= _d9c58831288052b4bb0dfa57ee24e75e_8466982124699937639.pathMask;
            }
            if (bitStream.ReadMask())
            {

                val.pathDirtyCounter = bitStream.ReadIntegerRange(32, -2147483648);
                val.FieldsMask |= _d9c58831288052b4bb0dfa57ee24e75e_8466982124699937639.pathDirtyCounterMask;
            }
        ...
        {
            return $"_d9c58831288052b4bb0dfa57ee24e75e_8466982124699937639(" +
                $" path: { this.path }" +
