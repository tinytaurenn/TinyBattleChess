...
namespace Coherence.Generated
{
    ...
    public struct _e4aae1ad1cbda6a4d803eda3efb9d15a_7139226417995560373 : ICoherenceComponentData
    {
        ...
        {
            FieldsMask |= _e4aae1ad1cbda6a4d803eda3efb9d15a_7139226417995560373.m_IsHeldMask;
            m_IsHeldSimulationFrame = frame;
            FieldsMask |= _e4aae1ad1cbda6a4d803eda3efb9d15a_7139226417995560373.IsNPCHeldMask;
            IsNPCHeldSimulationFrame = frame;
        }

        public static unsafe _e4aae1ad1cbda6a4d803eda3efb9d15a_7139226417995560373 FromInterop(IntPtr data, Int32 dataSize, InteropAbsoluteSimulationFrame* simFrames, Int32 simFramesCount)
        {
            if (dataSize != 2) {
            ...
            var orig = new _e4aae1ad1cbda6a4d803eda3efb9d15a_7139226417995560373();
        ...
        {
            var other = (_e4aae1ad1cbda6a4d803eda3efb9d15a_7139226417995560373)data;
        ...
        public static uint Serialize(_e4aae1ad1cbda6a4d803eda3efb9d15a_7139226417995560373 data, bool isRefSimFrameValid, AbsoluteSimulationFrame referenceSimulationFrame, IOutProtocolBitStream bitStream, Logger logger)
        {
        ...
        public static _e4aae1ad1cbda6a4d803eda3efb9d15a_7139226417995560373 Deserialize(AbsoluteSimulationFrame referenceSimulationFrame, InProtocolBitStream bitStream)
        {
            ...
            var val = new _e4aae1ad1cbda6a4d803eda3efb9d15a_7139226417995560373();
            if (bitStream.ReadMask())
            {

                val.m_IsHeld = bitStream.ReadBool();
                val.FieldsMask |= _e4aae1ad1cbda6a4d803eda3efb9d15a_7139226417995560373.m_IsHeldMask;
            }
            if (bitStream.ReadMask())
            {

                val.IsNPCHeld = bitStream.ReadBool();
                val.FieldsMask |= _e4aae1ad1cbda6a4d803eda3efb9d15a_7139226417995560373.IsNPCHeldMask;
            }
        ...
        {
            return $"_e4aae1ad1cbda6a4d803eda3efb9d15a_7139226417995560373(" +
