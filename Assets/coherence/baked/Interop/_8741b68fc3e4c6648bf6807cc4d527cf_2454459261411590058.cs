...
namespace Coherence.Generated
{
    ...
    public struct _8741b68fc3e4c6648bf6807cc4d527cf_2454459261411590058 : ICoherenceComponentData
    {
        ...
        {
            FieldsMask |= _8741b68fc3e4c6648bf6807cc4d527cf_2454459261411590058.pathMask;
            pathSimulationFrame = frame;
            FieldsMask |= _8741b68fc3e4c6648bf6807cc4d527cf_2454459261411590058.pathDirtyCounterMask;
            pathDirtyCounterSimulationFrame = frame;
        }

        public static unsafe _8741b68fc3e4c6648bf6807cc4d527cf_2454459261411590058 FromInterop(IntPtr data, Int32 dataSize, InteropAbsoluteSimulationFrame* simFrames, Int32 simFramesCount)
        {
            if (dataSize != 20) {
                throw new Exception($"Given data size is not equal to the struct size. ({dataSize} != 20) " +
                    "for component with ID 215");
            }
            ...
            var orig = new _8741b68fc3e4c6648bf6807cc4d527cf_2454459261411590058();
        ...
        public uint GetComponentType() => 215;
        ...
        {
            var other = (_8741b68fc3e4c6648bf6807cc4d527cf_2454459261411590058)data;
        ...
        public static uint Serialize(_8741b68fc3e4c6648bf6807cc4d527cf_2454459261411590058 data, bool isRefSimFrameValid, AbsoluteSimulationFrame referenceSimulationFrame, IOutProtocolBitStream bitStream, Logger logger)
        {
            ...
            if (bitStream.WriteMask((mask & 0x01) != 0))
            {
                ...
                Coherence.Utils.Bounds.Check(data.pathDirtyCounter, _pathDirtyCounter_Min, _pathDirtyCounter_Max, "_8741b68fc3e4c6648bf6807cc4d527cf_2454459261411590058.pathDirtyCounter", logger);
        ...
        public static _8741b68fc3e4c6648bf6807cc4d527cf_2454459261411590058 Deserialize(AbsoluteSimulationFrame referenceSimulationFrame, InProtocolBitStream bitStream)
        {
            ...
            var val = new _8741b68fc3e4c6648bf6807cc4d527cf_2454459261411590058();
            if (bitStream.ReadMask())
            {

                val.path = bitStream.ReadShortString();
                val.FieldsMask |= _8741b68fc3e4c6648bf6807cc4d527cf_2454459261411590058.pathMask;
            }
            if (bitStream.ReadMask())
            {

                val.pathDirtyCounter = bitStream.ReadIntegerRange(32, -2147483648);
                val.FieldsMask |= _8741b68fc3e4c6648bf6807cc4d527cf_2454459261411590058.pathDirtyCounterMask;
            }
        ...
        {
            return $"_8741b68fc3e4c6648bf6807cc4d527cf_2454459261411590058(" +
                $" path: { this.path }" +
