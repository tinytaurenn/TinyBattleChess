...
namespace Coherence.Generated
{
    ...
    public struct _094f983aa3a4b8b42bc4b2acba39e899_5293409725751720641 : ICoherenceComponentData
    {
        ...
        {
            FieldsMask |= _094f983aa3a4b8b42bc4b2acba39e899_5293409725751720641.m_IsHeldMask;
            m_IsHeldSimulationFrame = frame;
            FieldsMask |= _094f983aa3a4b8b42bc4b2acba39e899_5293409725751720641.IsNPCHeldMask;
            IsNPCHeldSimulationFrame = frame;
        }

        public static unsafe _094f983aa3a4b8b42bc4b2acba39e899_5293409725751720641 FromInterop(IntPtr data, Int32 dataSize, InteropAbsoluteSimulationFrame* simFrames, Int32 simFramesCount)
        {
            if (dataSize != 2) {
            ...
            var orig = new _094f983aa3a4b8b42bc4b2acba39e899_5293409725751720641();
        ...
        {
            var other = (_094f983aa3a4b8b42bc4b2acba39e899_5293409725751720641)data;
        ...
        public static uint Serialize(_094f983aa3a4b8b42bc4b2acba39e899_5293409725751720641 data, bool isRefSimFrameValid, AbsoluteSimulationFrame referenceSimulationFrame, IOutProtocolBitStream bitStream, Logger logger)
        {
        ...
        public static _094f983aa3a4b8b42bc4b2acba39e899_5293409725751720641 Deserialize(AbsoluteSimulationFrame referenceSimulationFrame, InProtocolBitStream bitStream)
        {
            ...
            var val = new _094f983aa3a4b8b42bc4b2acba39e899_5293409725751720641();
            if (bitStream.ReadMask())
            {

                val.m_IsHeld = bitStream.ReadBool();
                val.FieldsMask |= _094f983aa3a4b8b42bc4b2acba39e899_5293409725751720641.m_IsHeldMask;
            }
            if (bitStream.ReadMask())
            {

                val.IsNPCHeld = bitStream.ReadBool();
                val.FieldsMask |= _094f983aa3a4b8b42bc4b2acba39e899_5293409725751720641.IsNPCHeldMask;
            }
        ...
        {
            return $"_094f983aa3a4b8b42bc4b2acba39e899_5293409725751720641(" +
