...
namespace Coherence.Generated
{
    ...
    public struct _094f983aa3a4b8b42bc4b2acba39e899_4385417996844901296 : ICoherenceComponentData
    {
        ...
        {
            FieldsMask |= _094f983aa3a4b8b42bc4b2acba39e899_4385417996844901296.pathMask;
            pathSimulationFrame = frame;
            FieldsMask |= _094f983aa3a4b8b42bc4b2acba39e899_4385417996844901296.pathDirtyCounterMask;
            pathDirtyCounterSimulationFrame = frame;
        }

        public static unsafe _094f983aa3a4b8b42bc4b2acba39e899_4385417996844901296 FromInterop(IntPtr data, Int32 dataSize, InteropAbsoluteSimulationFrame* simFrames, Int32 simFramesCount)
        {
            if (dataSize != 20) {
            ...
            var orig = new _094f983aa3a4b8b42bc4b2acba39e899_4385417996844901296();
        ...
        {
            var other = (_094f983aa3a4b8b42bc4b2acba39e899_4385417996844901296)data;
        ...
        public static uint Serialize(_094f983aa3a4b8b42bc4b2acba39e899_4385417996844901296 data, bool isRefSimFrameValid, AbsoluteSimulationFrame referenceSimulationFrame, IOutProtocolBitStream bitStream, Logger logger)
        {
            ...
            if (bitStream.WriteMask((mask & 0x01) != 0))
            {
                ...
                Coherence.Utils.Bounds.Check(data.pathDirtyCounter, _pathDirtyCounter_Min, _pathDirtyCounter_Max, "_094f983aa3a4b8b42bc4b2acba39e899_4385417996844901296.pathDirtyCounter", logger);
        ...
        public static _094f983aa3a4b8b42bc4b2acba39e899_4385417996844901296 Deserialize(AbsoluteSimulationFrame referenceSimulationFrame, InProtocolBitStream bitStream)
        {
            ...
            var val = new _094f983aa3a4b8b42bc4b2acba39e899_4385417996844901296();
            if (bitStream.ReadMask())
            {

                val.path = bitStream.ReadShortString();
                val.FieldsMask |= _094f983aa3a4b8b42bc4b2acba39e899_4385417996844901296.pathMask;
            }
            if (bitStream.ReadMask())
            {

                val.pathDirtyCounter = bitStream.ReadIntegerRange(32, -2147483648);
                val.FieldsMask |= _094f983aa3a4b8b42bc4b2acba39e899_4385417996844901296.pathDirtyCounterMask;
            }
        ...
        {
            return $"_094f983aa3a4b8b42bc4b2acba39e899_4385417996844901296(" +
                $" path: { this.path }" +
