...
namespace Coherence.Generated
{
    ...
    public struct _406b1ac2c4f206b48b7f7599db0bf7a9_14447331401665559380 : ICoherenceComponentData
    {
        ...
        {
            FieldsMask |= _406b1ac2c4f206b48b7f7599db0bf7a9_14447331401665559380.pathMask;
            pathSimulationFrame = frame;
            FieldsMask |= _406b1ac2c4f206b48b7f7599db0bf7a9_14447331401665559380.pathDirtyCounterMask;
            pathDirtyCounterSimulationFrame = frame;
        }

        public static unsafe _406b1ac2c4f206b48b7f7599db0bf7a9_14447331401665559380 FromInterop(IntPtr data, Int32 dataSize, InteropAbsoluteSimulationFrame* simFrames, Int32 simFramesCount)
        {
            if (dataSize != 20) {
            ...
            var orig = new _406b1ac2c4f206b48b7f7599db0bf7a9_14447331401665559380();
        ...
        {
            var other = (_406b1ac2c4f206b48b7f7599db0bf7a9_14447331401665559380)data;
        ...
        public static uint Serialize(_406b1ac2c4f206b48b7f7599db0bf7a9_14447331401665559380 data, bool isRefSimFrameValid, AbsoluteSimulationFrame referenceSimulationFrame, IOutProtocolBitStream bitStream, Logger logger)
        {
            ...
            if (bitStream.WriteMask((mask & 0x01) != 0))
            {
                ...
                Coherence.Utils.Bounds.Check(data.pathDirtyCounter, _pathDirtyCounter_Min, _pathDirtyCounter_Max, "_406b1ac2c4f206b48b7f7599db0bf7a9_14447331401665559380.pathDirtyCounter", logger);
        ...
        public static _406b1ac2c4f206b48b7f7599db0bf7a9_14447331401665559380 Deserialize(AbsoluteSimulationFrame referenceSimulationFrame, InProtocolBitStream bitStream)
        {
            ...
            var val = new _406b1ac2c4f206b48b7f7599db0bf7a9_14447331401665559380();
            if (bitStream.ReadMask())
            {

                val.path = bitStream.ReadShortString();
                val.FieldsMask |= _406b1ac2c4f206b48b7f7599db0bf7a9_14447331401665559380.pathMask;
            }
            if (bitStream.ReadMask())
            {

                val.pathDirtyCounter = bitStream.ReadIntegerRange(32, -2147483648);
                val.FieldsMask |= _406b1ac2c4f206b48b7f7599db0bf7a9_14447331401665559380.pathDirtyCounterMask;
            }
        ...
        {
            return $"_406b1ac2c4f206b48b7f7599db0bf7a9_14447331401665559380(" +
                $" path: { this.path }" +
