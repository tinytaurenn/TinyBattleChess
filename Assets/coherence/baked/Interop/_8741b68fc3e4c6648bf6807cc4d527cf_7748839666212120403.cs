...
namespace Coherence.Generated
{
    ...
    public struct _8741b68fc3e4c6648bf6807cc4d527cf_7748839666212120403 : ICoherenceComponentData
    {
        ...
        {
            FieldsMask |= _8741b68fc3e4c6648bf6807cc4d527cf_7748839666212120403.m_IsHeldMask;
            m_IsHeldSimulationFrame = frame;
            FieldsMask |= _8741b68fc3e4c6648bf6807cc4d527cf_7748839666212120403.IsNPCHeldMask;
            IsNPCHeldSimulationFrame = frame;
        }

        public static unsafe _8741b68fc3e4c6648bf6807cc4d527cf_7748839666212120403 FromInterop(IntPtr data, Int32 dataSize, InteropAbsoluteSimulationFrame* simFrames, Int32 simFramesCount)
        {
            if (dataSize != 2) {
            ...
            var orig = new _8741b68fc3e4c6648bf6807cc4d527cf_7748839666212120403();
        ...
        {
            var other = (_8741b68fc3e4c6648bf6807cc4d527cf_7748839666212120403)data;
        ...
        public static uint Serialize(_8741b68fc3e4c6648bf6807cc4d527cf_7748839666212120403 data, bool isRefSimFrameValid, AbsoluteSimulationFrame referenceSimulationFrame, IOutProtocolBitStream bitStream, Logger logger)
        {
        ...
        public static _8741b68fc3e4c6648bf6807cc4d527cf_7748839666212120403 Deserialize(AbsoluteSimulationFrame referenceSimulationFrame, InProtocolBitStream bitStream)
        {
            ...
            var val = new _8741b68fc3e4c6648bf6807cc4d527cf_7748839666212120403();
            if (bitStream.ReadMask())
            {

                val.m_IsHeld = bitStream.ReadBool();
                val.FieldsMask |= _8741b68fc3e4c6648bf6807cc4d527cf_7748839666212120403.m_IsHeldMask;
            }
            if (bitStream.ReadMask())
            {

                val.IsNPCHeld = bitStream.ReadBool();
                val.FieldsMask |= _8741b68fc3e4c6648bf6807cc4d527cf_7748839666212120403.IsNPCHeldMask;
            }
        ...
        {
            return $"_8741b68fc3e4c6648bf6807cc4d527cf_7748839666212120403(" +
