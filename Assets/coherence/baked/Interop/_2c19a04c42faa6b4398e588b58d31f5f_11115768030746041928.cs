...
namespace Coherence.Generated
{
    ...
    public struct _2c19a04c42faa6b4398e588b58d31f5f_11115768030746041928 : ICoherenceComponentData
    {
        ...
        {
            FieldsMask |= _2c19a04c42faa6b4398e588b58d31f5f_11115768030746041928.m_IsHeldMask;
            m_IsHeldSimulationFrame = frame;
            FieldsMask |= _2c19a04c42faa6b4398e588b58d31f5f_11115768030746041928.IsNPCHeldMask;
            IsNPCHeldSimulationFrame = frame;
        }

        public static unsafe _2c19a04c42faa6b4398e588b58d31f5f_11115768030746041928 FromInterop(IntPtr data, Int32 dataSize, InteropAbsoluteSimulationFrame* simFrames, Int32 simFramesCount)
        {
            if (dataSize != 2) {
            ...
            var orig = new _2c19a04c42faa6b4398e588b58d31f5f_11115768030746041928();
        ...
        {
            var other = (_2c19a04c42faa6b4398e588b58d31f5f_11115768030746041928)data;
        ...
        public static uint Serialize(_2c19a04c42faa6b4398e588b58d31f5f_11115768030746041928 data, bool isRefSimFrameValid, AbsoluteSimulationFrame referenceSimulationFrame, IOutProtocolBitStream bitStream, Logger logger)
        {
        ...
        public static _2c19a04c42faa6b4398e588b58d31f5f_11115768030746041928 Deserialize(AbsoluteSimulationFrame referenceSimulationFrame, InProtocolBitStream bitStream)
        {
            ...
            var val = new _2c19a04c42faa6b4398e588b58d31f5f_11115768030746041928();
            if (bitStream.ReadMask())
            {

                val.m_IsHeld = bitStream.ReadBool();
                val.FieldsMask |= _2c19a04c42faa6b4398e588b58d31f5f_11115768030746041928.m_IsHeldMask;
            }
            if (bitStream.ReadMask())
            {

                val.IsNPCHeld = bitStream.ReadBool();
                val.FieldsMask |= _2c19a04c42faa6b4398e588b58d31f5f_11115768030746041928.IsNPCHeldMask;
            }
        ...
        {
            return $"_2c19a04c42faa6b4398e588b58d31f5f_11115768030746041928(" +
