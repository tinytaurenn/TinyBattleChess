...
namespace Coherence.Generated
{
    ...
    public struct _dd4f693a5d019d14ca62105d6772297f_3131434906551989761 : ICoherenceComponentData
    {
        ...
        {
            FieldsMask |= _dd4f693a5d019d14ca62105d6772297f_3131434906551989761.m_IsHeldMask;
            m_IsHeldSimulationFrame = frame;
            FieldsMask |= _dd4f693a5d019d14ca62105d6772297f_3131434906551989761.IsNPCHeldMask;
            IsNPCHeldSimulationFrame = frame;
        }

        public static unsafe _dd4f693a5d019d14ca62105d6772297f_3131434906551989761 FromInterop(IntPtr data, Int32 dataSize, InteropAbsoluteSimulationFrame* simFrames, Int32 simFramesCount)
        {
            if (dataSize != 2) {
            ...
            var orig = new _dd4f693a5d019d14ca62105d6772297f_3131434906551989761();
        ...
        {
            var other = (_dd4f693a5d019d14ca62105d6772297f_3131434906551989761)data;
        ...
        public static uint Serialize(_dd4f693a5d019d14ca62105d6772297f_3131434906551989761 data, bool isRefSimFrameValid, AbsoluteSimulationFrame referenceSimulationFrame, IOutProtocolBitStream bitStream, Logger logger)
        {
        ...
        public static _dd4f693a5d019d14ca62105d6772297f_3131434906551989761 Deserialize(AbsoluteSimulationFrame referenceSimulationFrame, InProtocolBitStream bitStream)
        {
            ...
            var val = new _dd4f693a5d019d14ca62105d6772297f_3131434906551989761();
            if (bitStream.ReadMask())
            {

                val.m_IsHeld = bitStream.ReadBool();
                val.FieldsMask |= _dd4f693a5d019d14ca62105d6772297f_3131434906551989761.m_IsHeldMask;
            }
            if (bitStream.ReadMask())
            {

                val.IsNPCHeld = bitStream.ReadBool();
                val.FieldsMask |= _dd4f693a5d019d14ca62105d6772297f_3131434906551989761.IsNPCHeldMask;
            }
        ...
        {
            return $"_dd4f693a5d019d14ca62105d6772297f_3131434906551989761(" +
