...
namespace Coherence.Generated
{
    ...
    public struct _5ca4159d3bce41449a6ca5773f57e7ef_6247734567211433748 : ICoherenceComponentData
    {
        ...
        {
            FieldsMask |= _5ca4159d3bce41449a6ca5773f57e7ef_6247734567211433748.m_IsHeldMask;
            m_IsHeldSimulationFrame = frame;
            FieldsMask |= _5ca4159d3bce41449a6ca5773f57e7ef_6247734567211433748.IsNPCHeldMask;
            IsNPCHeldSimulationFrame = frame;
        }

        public static unsafe _5ca4159d3bce41449a6ca5773f57e7ef_6247734567211433748 FromInterop(IntPtr data, Int32 dataSize, InteropAbsoluteSimulationFrame* simFrames, Int32 simFramesCount)
        {
            if (dataSize != 2) {
            ...
            var orig = new _5ca4159d3bce41449a6ca5773f57e7ef_6247734567211433748();
        ...
        {
            var other = (_5ca4159d3bce41449a6ca5773f57e7ef_6247734567211433748)data;
        ...
        public static uint Serialize(_5ca4159d3bce41449a6ca5773f57e7ef_6247734567211433748 data, bool isRefSimFrameValid, AbsoluteSimulationFrame referenceSimulationFrame, IOutProtocolBitStream bitStream, Logger logger)
        {
        ...
        public static _5ca4159d3bce41449a6ca5773f57e7ef_6247734567211433748 Deserialize(AbsoluteSimulationFrame referenceSimulationFrame, InProtocolBitStream bitStream)
        {
            ...
            var val = new _5ca4159d3bce41449a6ca5773f57e7ef_6247734567211433748();
            if (bitStream.ReadMask())
            {

                val.m_IsHeld = bitStream.ReadBool();
                val.FieldsMask |= _5ca4159d3bce41449a6ca5773f57e7ef_6247734567211433748.m_IsHeldMask;
            }
            if (bitStream.ReadMask())
            {

                val.IsNPCHeld = bitStream.ReadBool();
                val.FieldsMask |= _5ca4159d3bce41449a6ca5773f57e7ef_6247734567211433748.IsNPCHeldMask;
            }
        ...
        {
            return $"_5ca4159d3bce41449a6ca5773f57e7ef_6247734567211433748(" +
