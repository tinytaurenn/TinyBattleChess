...
namespace Coherence.Generated
{
    ...
    public struct _5bdd7302d83b75e4ea45b36178bc0730_8012800132177806423 : ICoherenceComponentData
    {
        ...
        {
            FieldsMask |= _5bdd7302d83b75e4ea45b36178bc0730_8012800132177806423.positionMask;
            positionSimulationFrame = frame;
            FieldsMask |= _5bdd7302d83b75e4ea45b36178bc0730_8012800132177806423.rotationMask;
            rotationSimulationFrame = frame;
        }

        public static unsafe _5bdd7302d83b75e4ea45b36178bc0730_8012800132177806423 FromInterop(IntPtr data, Int32 dataSize, InteropAbsoluteSimulationFrame* simFrames, Int32 simFramesCount)
        {
            if (dataSize != 28) {
            ...
            var orig = new _5bdd7302d83b75e4ea45b36178bc0730_8012800132177806423();
        ...
        public AbsoluteSimulationFrame? GetMinSimulationFrame()
        {
            ...
            if ((FieldsMask & _5bdd7302d83b75e4ea45b36178bc0730_8012800132177806423.positionMask) != 0 && (min == null || this.positionSimulationFrame < min))
            {
                min = this.positionSimulationFrame;
            }
            if ((FieldsMask & _5bdd7302d83b75e4ea45b36178bc0730_8012800132177806423.rotationMask) != 0 && (min == null || this.rotationSimulationFrame < min))
            {
        ...
        {
            var other = (_5bdd7302d83b75e4ea45b36178bc0730_8012800132177806423)data;
        ...
        public static uint Serialize(_5bdd7302d83b75e4ea45b36178bc0730_8012800132177806423 data, bool isRefSimFrameValid, AbsoluteSimulationFrame referenceSimulationFrame, IOutProtocolBitStream bitStream, Logger logger)
        {
        ...
        public static _5bdd7302d83b75e4ea45b36178bc0730_8012800132177806423 Deserialize(AbsoluteSimulationFrame referenceSimulationFrame, InProtocolBitStream bitStream)
        {
            ...
            var val = new _5bdd7302d83b75e4ea45b36178bc0730_8012800132177806423();
            if (bitStream.ReadMask())
            {
                ...
                val.FieldsMask |= _5bdd7302d83b75e4ea45b36178bc0730_8012800132177806423.positionMask;
            }
            if (bitStream.ReadMask())
            {
                ...
                val.FieldsMask |= _5bdd7302d83b75e4ea45b36178bc0730_8012800132177806423.rotationMask;
            }
        ...
        {
            return $"_5bdd7302d83b75e4ea45b36178bc0730_8012800132177806423(" +
