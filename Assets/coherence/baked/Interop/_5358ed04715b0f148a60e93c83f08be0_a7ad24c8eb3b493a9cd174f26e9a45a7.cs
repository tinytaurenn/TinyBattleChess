...
namespace Coherence.Generated
{
    ...
    public struct _5358ed04715b0f148a60e93c83f08be0_a7ad24c8eb3b493a9cd174f26e9a45a7 : IEntityCommand
    {
        ...
        public static unsafe _5358ed04715b0f148a60e93c83f08be0_a7ad24c8eb3b493a9cd174f26e9a45a7 FromInterop(System.IntPtr data, System.Int32 dataSize) 
        {
            if (dataSize != 8) {
            ...
            var orig = new _5358ed04715b0f148a60e93c83f08be0_a7ad24c8eb3b493a9cd174f26e9a45a7();
        ...
        public _5358ed04715b0f148a60e93c83f08be0_a7ad24c8eb3b493a9cd174f26e9a45a7(
        Entity entity,
        System.Int32 damage,
        Entity Damagersync
)
        ...
        public static void Serialize(_5358ed04715b0f148a60e93c83f08be0_a7ad24c8eb3b493a9cd174f26e9a45a7 commandData, IOutProtocolBitStream bitStream)
        {
            bitStream.WriteIntegerRange(commandData.damage, 32, -2147483648);
            bitStream.WriteEntity(commandData.Damagersync);
        }
        
        public static _5358ed04715b0f148a60e93c83f08be0_a7ad24c8eb3b493a9cd174f26e9a45a7 Deserialize(IInProtocolBitStream bitStream, Entity entity, MessageTarget target)
        {
            var datadamage = bitStream.ReadIntegerRange(32, -2147483648);
            var dataDamagersync = bitStream.ReadEntity();
    
            return new _5358ed04715b0f148a60e93c83f08be0_a7ad24c8eb3b493a9cd174f26e9a45a7()
            {
                Entity = entity,
                Routing = target,
                damage = datadamage,
