...
namespace Coherence.Generated
{
    ...
    public struct _2c19a04c42faa6b4398e588b58d31f5f_17001797403845922607 : ICoherenceComponentData
    {
        ...
        {
            FieldsMask |= _2c19a04c42faa6b4398e588b58d31f5f_17001797403845922607.pathMask;
            pathSimulationFrame = frame;
            FieldsMask |= _2c19a04c42faa6b4398e588b58d31f5f_17001797403845922607.pathDirtyCounterMask;
            pathDirtyCounterSimulationFrame = frame;
        }

        public static unsafe _2c19a04c42faa6b4398e588b58d31f5f_17001797403845922607 FromInterop(IntPtr data, Int32 dataSize, InteropAbsoluteSimulationFrame* simFrames, Int32 simFramesCount)
        {
            if (dataSize != 20) {
            ...
            var orig = new _2c19a04c42faa6b4398e588b58d31f5f_17001797403845922607();
        ...
        {
            var other = (_2c19a04c42faa6b4398e588b58d31f5f_17001797403845922607)data;
        ...
        public static uint Serialize(_2c19a04c42faa6b4398e588b58d31f5f_17001797403845922607 data, bool isRefSimFrameValid, AbsoluteSimulationFrame referenceSimulationFrame, IOutProtocolBitStream bitStream, Logger logger)
        {
            ...
            if (bitStream.WriteMask((mask & 0x01) != 0))
            {
                ...
                Coherence.Utils.Bounds.Check(data.pathDirtyCounter, _pathDirtyCounter_Min, _pathDirtyCounter_Max, "_2c19a04c42faa6b4398e588b58d31f5f_17001797403845922607.pathDirtyCounter", logger);
        ...
        public static _2c19a04c42faa6b4398e588b58d31f5f_17001797403845922607 Deserialize(AbsoluteSimulationFrame referenceSimulationFrame, InProtocolBitStream bitStream)
        {
            ...
            var val = new _2c19a04c42faa6b4398e588b58d31f5f_17001797403845922607();
            if (bitStream.ReadMask())
            {

                val.path = bitStream.ReadShortString();
                val.FieldsMask |= _2c19a04c42faa6b4398e588b58d31f5f_17001797403845922607.pathMask;
            }
            if (bitStream.ReadMask())
            {

                val.pathDirtyCounter = bitStream.ReadIntegerRange(32, -2147483648);
                val.FieldsMask |= _2c19a04c42faa6b4398e588b58d31f5f_17001797403845922607.pathDirtyCounterMask;
            }
        ...
        {
            return $"_2c19a04c42faa6b4398e588b58d31f5f_17001797403845922607(" +
                $" path: { this.path }" +
