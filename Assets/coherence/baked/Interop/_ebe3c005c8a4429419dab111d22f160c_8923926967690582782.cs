...
namespace Coherence.Generated
{
    ...
    public struct _ebe3c005c8a4429419dab111d22f160c_8923926967690582782 : ICoherenceComponentData
    {
        ...
        {
            FieldsMask |= _ebe3c005c8a4429419dab111d22f160c_8923926967690582782.pathMask;
            pathSimulationFrame = frame;
            FieldsMask |= _ebe3c005c8a4429419dab111d22f160c_8923926967690582782.pathDirtyCounterMask;
            pathDirtyCounterSimulationFrame = frame;
        }

        public static unsafe _ebe3c005c8a4429419dab111d22f160c_8923926967690582782 FromInterop(IntPtr data, Int32 dataSize, InteropAbsoluteSimulationFrame* simFrames, Int32 simFramesCount)
        {
            if (dataSize != 20) {
                throw new Exception($"Given data size is not equal to the struct size. ({dataSize} != 20) " +
                    "for component with ID 248");
            }
            ...
            var orig = new _ebe3c005c8a4429419dab111d22f160c_8923926967690582782();
        ...
        public uint GetComponentType() => 248;
        ...
        {
            var other = (_ebe3c005c8a4429419dab111d22f160c_8923926967690582782)data;
        ...
        public static uint Serialize(_ebe3c005c8a4429419dab111d22f160c_8923926967690582782 data, bool isRefSimFrameValid, AbsoluteSimulationFrame referenceSimulationFrame, IOutProtocolBitStream bitStream, Logger logger)
        {
            ...
            if (bitStream.WriteMask((mask & 0x01) != 0))
            {
                ...
                Coherence.Utils.Bounds.Check(data.pathDirtyCounter, _pathDirtyCounter_Min, _pathDirtyCounter_Max, "_ebe3c005c8a4429419dab111d22f160c_8923926967690582782.pathDirtyCounter", logger);
        ...
        public static _ebe3c005c8a4429419dab111d22f160c_8923926967690582782 Deserialize(AbsoluteSimulationFrame referenceSimulationFrame, InProtocolBitStream bitStream)
        {
            ...
            var val = new _ebe3c005c8a4429419dab111d22f160c_8923926967690582782();
            if (bitStream.ReadMask())
            {

                val.path = bitStream.ReadShortString();
                val.FieldsMask |= _ebe3c005c8a4429419dab111d22f160c_8923926967690582782.pathMask;
            }
            if (bitStream.ReadMask())
            {

                val.pathDirtyCounter = bitStream.ReadIntegerRange(32, -2147483648);
                val.FieldsMask |= _ebe3c005c8a4429419dab111d22f160c_8923926967690582782.pathDirtyCounterMask;
            }
        ...
        {
            return $"_ebe3c005c8a4429419dab111d22f160c_8923926967690582782(" +
                $" path: { this.path }" +
